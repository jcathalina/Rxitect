...
from rxitect.models import FragmentBasedGFN, bengio2021flow
from rxitect.tasks import FlatRewards, GFNTask, ScalarReward
...
class SEHTask(GFNTask):
    ...
    def sample_conditional_information(self, n):
        ...
        beta_enc = thermometer(
            torch.tensor(beta), 32, 0, upper_bound
...
def main():
    ...
    hps = {
        "lr_decay": 10000,
        "log_dir": "rxitect/scratch/logs/seh_frag/run_0/",
...
if __name__ == "__main__":
    main()
    # TODO: Bugfix issue with Boost::Python not importing, might be a 3.8 specific issue. First thought) Try updating to 3.9?
