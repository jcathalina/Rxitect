...
class MPModelProxy:
    ...
    This placeholder model sends messages across multiprocessing
    ...
    def __init__(self, model: nn.Module, num_workers: int, cast_types: Tuple):
...
def wrap_model_mp(model: nn.Module, num_workers: int, cast_types: Tuple) -> MPModelPlaceholder:
