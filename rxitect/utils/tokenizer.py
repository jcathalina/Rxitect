...
class Tokenizer(ABC):
    """Abstract base class for tokenizers, defining the interface that can
    subsequently be used in dataset/datamodules/models.
    """
    def __init__(self,
                 pad_token: str = " ",
                 start_token: str = "[SOS]",
        ...
        self.sentinel_tokens = [pad_token,
                                start_token,
                                end_token,
                                missing_token]  # Pad should always be first.
